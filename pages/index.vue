...
<template>
  <NuxtLayout>
    <div class="w-full">
      <div class="container mx-auto py-36 px-4 min-h-full">
        <div class="grid md:grid-cols-2">
          <div class="space-y-4">
            <div>
              <UIcon name="lucide:wallet-2" class="text-8xl"/>
            </div>
            <h1 class="text-4xl md:text-8xl font-bold">Pocket Track</h1>
            <h2 class="text-lg">Unlock financial freedom with Pocket Track – Your Personal Expense Wizard! Effortlessly
              track,
              manage, and conquer your expenses on the go. Take charge of your budget, one transaction at a time. Start
              your
              journey to financial empowerment today!</h2>
            <div class="flex flex-col md:flex-row gap-4">
              <UButton to="api/login" size="lg" class="justify-center" external>Continue to Dashboard</UButton>
              <UButton to="api/register" size="lg" variant="outline" class="justify-center" external>Sign Up</UButton>
            </div>
          </div>
          <div  class="hidden md:block">

            <svg xmlns="http://www.w3.org/2000/svg" class="h-96" data-name="Layer 1" width="590.81881" height="646.93595"
                 viewBox="0 0 590.81881 646.93595" xmlns:xlink="http://www.w3.org/1999/xlink">
              <circle cx="119.02093" cy="512.16388" r="14.92017" fill="#f0f0f0" style="isolation:isolate"/>
              <circle cx="91.40748" cy="519.28992" r="10.46638" fill="#f0f0f0" style="isolation:isolate"/>
              ...
              <polygon points="8.915 130 6.915 130 6.915 0 134.915 0 134.915 2 8.915 2 8.915 130" fill="#ccc"/>
              <polygon points="590.819 130 588.819 130 588.819 2 462.819 2 462.819 0 590.819 0 590.819 130"
                       fill="#ccc"/>
              <polygon points="8.915 240 6.915 240 6.915 370 134.915 370 134.915 368 8.915 368 8.915 240" fill="#ccc"/>
              <polygon points="590.819 240 588.819 240 588.819 368 462.819 368 462.819 370 590.819 370 590.819 240"
                       fill="#ccc"/>
              ...
              <rect x="592.3237" y="663.46816" width="54.14795" height="1.99957"
                    transform="translate(-351.90571 -79.04478) rotate(-4.22916)" fill="#cacaca"/>
              <rect x="565.3979" y="649.55525" width="1.99957" height="22.82544"
                    transform="translate(-590.30121 712.18978) rotate(-61.18921)" fill="#cacaca"/>
              <rect x="290.80709" y="520.93595" width="18" height="2" fill="#cacaca"/>
              <polygon points="243.805 646.004 241.809 645.868 256.809 416.868 258.805 417.004 243.805 646.004"
                       fill="#cacaca"/>
              <polygon points="317.808 645.985 307.808 434.985 309.806 434.887 319.806 645.887 317.808 645.985"
                       fill="#cacaca"/>
              <rect x="649.89755" y="542.07622" width="2.00037" height="230.78345"
                    transform="translate(-356.50794 -70.71426) rotate(-4.72229)" fill="#cacaca"/>
              <polygon points="274.807 645.96 272.807 645.912 278.807 434.912 280.807 434.96 274.807 645.96"
                       fill="#cacaca"/>
              <polygon points="265.236 513.691 251.954 521.557 215.29 474.07 234.894 462.459 265.236 513.691"
                       fill="#ffb6b6"/>
              <path
                  ...
                  transform="translate(-304.5906 -126.53203)" fill="#2f2e41"/>
              <polygon points="329.378 513.691 342.66 521.557 379.324 474.07 359.721 462.459 329.378 513.691"
                       fill="#ffb6b6"/>
              <path
              ...
              <path
                  ...
                  transform="translate(-304.5906 -126.53203)" fill="#695ef7"/>
              <path
              ...
              <polygon
                  ...
                  fill="#2f2e41"/>
              <path d="M553.57955,374.532l22.5,87.991S565.57955,385.532,553.57955,374.532Z"
                    transform="translate(-304.5906 -126.53203)" opacity="0.2" style="isolation:isolate"/>
              <path d="M620.71582,463.523l22.5-87.991C631.21582,386.532,620.71582,463.523,620.71582,463.523Z"
                    transform="translate(-304.5906 -126.53203)" opacity="0.2" style="isolation:isolate"/>
              <path
                  ...
                  transform="translate(-304.5906 -126.53203)" fill="#ffb6b6"/>
              <path
              ...
              <path
                  ...
                  transform="translate(-304.5906 -126.53203)" fill="#695ef7"/>
              <path d="M888.5906,773.468h-583a1,1,0,0,1,0-2h583a1,1,0,0,1,0,2Z"
                    transform="translate(-304.5906 -126.53203)" fill="#e4e4e4"/>
              <path
      ...
      <div class="pb-28">
        ...
        <span class="text-gray-500">Developed by <a href="" class="text-primary underline">yassinnedie9121@gmail.com</a> as a submission for <a
            href="https://crackeddevs.devpost.com/" target="_blank"
            class="text-primary underline">CrackedDevs Hackathon</a></span>
        </div>
      </div>
    </div>
  </NuxtLayout>
